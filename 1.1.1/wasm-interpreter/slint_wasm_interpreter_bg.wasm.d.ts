...
export function wasm_bindgen__convert__closures__invoke1_mut__h16ef24706733cae3(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hc0fbacfc9795b793(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1__h05687163e529980d(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hbdc2c0259f83b263(a: number, b: number, c: number, d: number): void;
