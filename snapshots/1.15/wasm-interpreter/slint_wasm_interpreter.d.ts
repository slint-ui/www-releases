...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h17eb399921b71be9: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__ha81618378c59e7e0: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h24fc876a05d193d7: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h13d090741f710423: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h008608d81f594293: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1bb4d8a6818ac072: (a: number, b: number) => void;
