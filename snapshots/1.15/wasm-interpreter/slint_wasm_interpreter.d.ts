...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0a8e2f82d702da7b: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h593e443eb8f914f7: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h61741c935084861c: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h8c3ddbfd7b626b77: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h03fe6e4c0dd9336a: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h9589b9bb36a78b2a: (a: number, b: number) => void;
