...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h112117ee0fee87bc: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h33a643d65c67f5a0: (a: number, b: number, c: any) => void;
