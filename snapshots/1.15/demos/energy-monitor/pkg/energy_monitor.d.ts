...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0d479cba78601f37: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h07c9ed7bfff3bbbb: (a: number, b: number, c: any) => void;
