...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h069f38221848140f: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h0c4684cd513aad0a: (a: number, b: number, c: any) => void;
