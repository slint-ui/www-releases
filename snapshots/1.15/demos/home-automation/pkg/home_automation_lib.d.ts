...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h31ccfd131d0d08d5: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h1535454b329566ca: (a: number, b: number, c: any) => void;
