...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h29fcae34cb7e3fad: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h0312e27c0f61c2a2: (a: number, b: number, c: any) => void;
