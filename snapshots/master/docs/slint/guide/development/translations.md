...
See [Converting Between Numbers and Strings](/master/docs/slint/reference/property-types/builtin-types.md#converting-between-numbers-and-strings) for the conversion rules.
