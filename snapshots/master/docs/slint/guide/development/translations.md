...
See [Converting Between Numbers and Strings](/master/docs/slint/reference/language/type-conversions.md#converting-between-numbers-and-strings) for the conversion rules.
