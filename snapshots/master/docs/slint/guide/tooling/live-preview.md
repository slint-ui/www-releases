...
:::note
This is different from the live preview in [VS Code](/master/docs/slint/guide/tooling/vscode.md)
or the [Slint LSP](/master/docs/slint/guide/tooling/manual-setup.md#slint-lsp),
