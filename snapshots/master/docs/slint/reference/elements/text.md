...
:::note[Note]
  ...
  See [FontHandling](/master/docs/slint/guide/development/fonts.md) for more.
:::
</SlintProperty>
...
The weight of the font. The values range from 100 (lightest) to 900 (thickest). 400 is the normal weight. Use the [FontWeight](/master/docs/slint/reference/global-namespaces/font-weight.md) namespace for predefined constants.
