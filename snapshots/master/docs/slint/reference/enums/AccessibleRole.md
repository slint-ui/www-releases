...
description: "AccessibleRole content"
---
...
* **`content-info`**:  Landmark: information about the application or its content, typically at the bottom (e.g. status bar, copyright).
...
* **`region`**:  Landmark: a generic section significant enough to be listed in a summary. Use a more specific landmark if one applies.
