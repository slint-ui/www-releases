...
The `FocusScope` can react to [keyboard shortcuts](/master/docs/slint/reference/keyboard-input/overview.md#key-bindings) using the [KeyBinding element](/master/docs/slint/reference/keyboard-input/focusscope.md#keybinding), and exposes callbacks to handle key events manually.
