...
A widget used to enter a single line of text. See [TextEdit](/master/docs/slint/reference/std-widgets/views/textedit.md) for
...
### clear-focus()
Call this function to remove keyboard focus from this `LineEdit` if it currently has the focus. See also [FocusHandling](/master/docs/slint/guide/development/focus.md).
