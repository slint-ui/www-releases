...
A simple button. Common types of buttons can also be created with [StandardButton](/master/docs/slint/reference/std-widgets/basic-widgets/standardbutton.md).
