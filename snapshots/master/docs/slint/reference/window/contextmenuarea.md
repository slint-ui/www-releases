...
Place the `Menu` element in a [MenuBar](/master/docs/slint/reference/window/menubar.md), a `ContextMenuArea`, or within another `Menu`.
...
This property can only be set in a `MenuItem` that is part of a [MenuBar](/master/docs/slint/reference/window/menubar.md).
</SlintProperty>
