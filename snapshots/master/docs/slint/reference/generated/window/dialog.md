...
Dialog can be used in place of [Window](/master/docs/slint/reference/generated/window/window.md), but it has buttons that are automatically laid out.
...
Same as [Window](/master/docs/slint/reference/generated/window/window.md).
