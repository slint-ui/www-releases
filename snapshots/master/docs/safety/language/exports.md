...
Export statements may appear at the top level of a `.slint` source file, interleaved with [component definitions](/language/file-structure/#sls.file.component.definition-forms). \{#sls.export.placement}
