...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h437c525b4cd1aee5: (a: number, b: number) => void;
