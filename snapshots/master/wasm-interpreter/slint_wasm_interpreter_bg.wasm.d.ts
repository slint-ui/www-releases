...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3ebbf5e761e7dd88(a: number, b: number): void;
export function closure667_externref_shim(a: number, b: number, c: number): void;
export function closure678_externref_shim(a: number, b: number, c: number, d: number): void;
