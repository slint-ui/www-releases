...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6269616cd618ca48(a: number, b: number): void;
export function closure668_externref_shim(a: number, b: number, c: number): void;
export function closure679_externref_shim(a: number, b: number, c: number, d: number): void;
