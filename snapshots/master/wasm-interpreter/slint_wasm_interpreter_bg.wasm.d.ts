...
export function closure167_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h39c51fbadc838b91(a: number, b: number): void;
export function closure645_externref_shim(a: number, b: number, c: number): void;
export function closure656_externref_shim(a: number, b: number, c: number, d: number): void;
