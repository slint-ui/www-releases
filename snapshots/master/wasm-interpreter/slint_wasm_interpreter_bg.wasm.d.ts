...
export function closure130_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7fa73a67160170e7(a: number, b: number): void;
export function closure646_externref_shim(a: number, b: number, c: number): void;
export function closure655_externref_shim(a: number, b: number, c: number, d: number): void;
