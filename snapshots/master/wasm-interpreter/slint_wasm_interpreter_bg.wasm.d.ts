...
export const wasm_bindgen__convert__closures_____invoke__h06c5b93f1b3c457b: (a: number, b: number, c: any) => void;
export const wasm_bindgen__closure__destroy__h3f86539d65672e5f: (a: number, b: number) => void;
