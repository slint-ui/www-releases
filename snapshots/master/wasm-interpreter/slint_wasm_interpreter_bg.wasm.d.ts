...
export function closure139_externref_shim(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h024f5d8c081f9f65(a: number, b: number): void;
export function closure671_externref_shim(a: number, b: number, c: number): void;
export function closure676_externref_shim(a: number, b: number, c: number, d: number): void;
