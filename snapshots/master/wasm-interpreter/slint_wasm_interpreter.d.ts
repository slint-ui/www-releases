...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h36061e68ac8279a7: (a: number, b: number) => void;
  readonly closure671_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure682_externref_shim: (a: number, b: number, c: any, d: any) => void;
