...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h30ccd1d89a8b304a: (a: number, b: number) => void;
  readonly closure666_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure676_externref_shim: (a: number, b: number, c: any, d: any) => void;
