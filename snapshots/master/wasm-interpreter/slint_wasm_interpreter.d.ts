...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0b3f35d596288ffc: (a: number, b: number) => void;
  readonly closure662_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure667_externref_shim: (a: number, b: number, c: any, d: any) => void;
