...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h5ac6966229c6b68f: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h088f18823af0c06e: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h078837d2c91d119f: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h114ee8599fed51de: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__h7bac01187dd8d1d3: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h0341529eec425534: (a: number, b: number, c: any, d: any) => void;
