...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hce1f9159bd897e3a: (a: number, b: number) => void;
  readonly closure591_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure601_externref_shim: (a: number, b: number, c: any, d: any) => void;
