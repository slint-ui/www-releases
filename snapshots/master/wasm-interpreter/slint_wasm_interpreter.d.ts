...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h901c77a0b6aa36c9: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h0393bd2e14d2d546: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__hd4affbd01c754ffc: (a: number, b: number) => void;
