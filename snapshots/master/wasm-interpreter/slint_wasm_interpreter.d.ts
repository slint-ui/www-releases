...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4281ba60f7c1f660: (a: number, b: number) => void;
  readonly closure565_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure576_externref_shim: (a: number, b: number, c: any, d: any) => void;
