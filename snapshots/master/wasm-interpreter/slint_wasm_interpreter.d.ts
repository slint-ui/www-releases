...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2e72eb5cb8a938c3: (a: number, b: number) => void;
  readonly closure563_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure573_externref_shim: (a: number, b: number, c: any, d: any) => void;
