...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h2767067993b4eaa0: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__convert__closures_____invoke__h2555a56f0364938f: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__ha00fa7d6c6ad9cfc: (a: number, b: number) => void;
