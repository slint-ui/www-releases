...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6c1d9ed88de0bfdb: (a: number, b: number, c: number) => void;
