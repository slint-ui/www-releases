...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h068d2cbe23c59ac5: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__hf5b65fc94693ebbb: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h65488d6319c772d1: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h20f77cb0a645efb0: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0cd7d9c363112fde: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h42e754d3a3b99d39: (a: number, b: number) => void;
