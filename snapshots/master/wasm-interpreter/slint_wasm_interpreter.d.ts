...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0167cb3a01b765c2: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__had3b5c819a6fb82a: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h9f799df490f93f81: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h09ef1dc90387ffe4: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h156317a969d345fa: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2d0a5ae6be3bf6bf: (a: number, b: number) => void;
