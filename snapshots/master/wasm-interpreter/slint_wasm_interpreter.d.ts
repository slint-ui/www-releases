...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h2cdd1e5a8f821438: (a: number, b: number, c: any) => void;
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h4246c8a474be6698: (a: number, b: number) => void;
  readonly wasm_bindgen__closure__destroy__hc54317930f4d5d2a: (a: number, b: number) => void;
