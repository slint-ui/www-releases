...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbab7e852ee378500: (a: number, b: number) => void;
  readonly closure577_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure584_externref_shim: (a: number, b: number, c: any, d: any) => void;
