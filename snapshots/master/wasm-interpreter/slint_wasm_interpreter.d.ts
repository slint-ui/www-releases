...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h0cf3b3cd9b954edf: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h945e49bff1f0eeaa: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h3b8c46badca65ec4: (a: number, b: number, c: any) => void;
