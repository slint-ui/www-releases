...
export interface InitOutput {
  ...
  readonly closure167_externref_shim: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7b169a424885084a: (a: number, b: number) => void;
  readonly closure645_externref_shim: (a: number, b: number, c: number) => void;
  readonly closure656_externref_shim: (a: number, b: number, c: number, d: number) => void;
