...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h1dc50fd0ae2b99d1: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1dc50fd0ae2b99d1_5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0d54574b5abc0e2b_6: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1dc50fd0ae2b99d1_7: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0d54574b5abc0e2b_8: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1dc50fd0ae2b99d1_9: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0d54574b5abc0e2b_10: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1dc50fd0ae2b99d1_11: (a: number, b: number, c: any) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h1dc50fd0ae2b99d1_14: (a: number, b: number, c: any) => void;
