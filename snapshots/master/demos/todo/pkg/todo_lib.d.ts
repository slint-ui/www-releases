...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h18cabbb4a32d5af3: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h143f85c621d4d137: (a: number, b: number) => void;
