...
export const closure1335_externref_shim: (a: number, b: number, c: any) => void;
export const closure1680_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1681_externref_shim: (a: number, b: number, c: any, d: any) => void;
