...
export const closure1180_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1663_externref_shim: (a: number, b: number, c: any) => void;
export const closure1664_externref_shim: (a: number, b: number, c: any, d: any) => void;
