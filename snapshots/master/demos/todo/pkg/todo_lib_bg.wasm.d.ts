...
export const closure1878_externref_shim: (a: number, b: number, c: any) => void;
export const closure1404_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1941_externref_shim: (a: number, b: number, c: any) => void;
