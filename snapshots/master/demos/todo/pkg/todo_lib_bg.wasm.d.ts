...
export const closure1651_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure1652_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure1690_externref_shim: (a: number, b: number, c: any) => void;
