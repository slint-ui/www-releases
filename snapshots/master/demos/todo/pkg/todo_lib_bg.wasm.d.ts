...
export const closure1517_externref_shim: (a: number, b: number, c: any) => void;
export const closure1867_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h8d77d366304a298b: (a: number, b: number) => void;
export const closure1868_externref_shim: (a: number, b: number, c: any, d: any) => void;
