...
export const closure2433_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2495_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h7da38fb784c850d4: (a: number, b: number) => void;
