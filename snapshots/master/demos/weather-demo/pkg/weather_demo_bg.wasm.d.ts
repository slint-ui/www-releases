...
export const closure2055_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h581d4cc86feb52cc: (a: number, b: number) => void;
