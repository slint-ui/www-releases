...
export const closure2047_externref_shim: (a: number, b: number, c: any) => void;
...
export const wasm_bindgen__convert__closures_____invoke__hae63bfd2b60c581e: (a: number, b: number) => void;
