...
export const closure2012_externref_shim: (a: number, b: number, c: any) => void;
export const closure2359_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hcfa5eff717aac2dc: (a: number, b: number) => void;
export const closure2360_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2422_externref_shim: (a: number, b: number, c: any) => void;
