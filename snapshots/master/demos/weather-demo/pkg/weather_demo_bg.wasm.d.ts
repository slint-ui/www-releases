...
export const closure2153_externref_shim: (a: number, b: number, c: any) => void;
export const closure2435_externref_shim: (a: number, b: number, c: any) => void;
export const closure2498_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h9da4262ad8cc4ad2: (a: number, b: number) => void;
export const closure2436_externref_shim: (a: number, b: number, c: any, d: any) => void;
