...
export const closure2400_externref_shim: (a: number, b: number, c: any) => void;
export const closure2401_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure1894_externref_shim: (a: number, b: number, c: any) => void;
export const closure2463_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h9da4262ad8cc4ad2: (a: number, b: number) => void;
