...
export const closure2120_externref_shim: (a: number, b: number, c: any) => void;
export const closure2428_externref_shim: (a: number, b: number, c: any) => void;
export const closure2491_externref_shim: (a: number, b: number, c: any) => void;
export const closure2429_externref_shim: (a: number, b: number, c: any, d: any) => void;
