...
export const closure2031_externref_shim: (a: number, b: number, c: any) => void;
export const closure2431_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h4f747c8a734dafd1: (a: number, b: number) => void;
export const closure2432_externref_shim: (a: number, b: number, c: any, d: any) => void;
