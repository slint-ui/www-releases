...
export const closure2068_externref_shim: (a: number, b: number, c: any) => void;
export const closure2421_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hf9f0ca328ac5531d: (a: number, b: number) => void;
export const closure2422_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2472_externref_shim: (a: number, b: number, c: any) => void;
