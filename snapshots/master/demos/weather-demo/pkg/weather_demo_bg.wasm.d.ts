...
export const closure1952_externref_shim: (a: number, b: number, c: any) => void;
export const closure2490_externref_shim: (a: number, b: number, c: any) => void;
export const closure2427_externref_shim: (a: number, b: number, c: any) => void;
export const closure2428_externref_shim: (a: number, b: number, c: any, d: any) => void;
