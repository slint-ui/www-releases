...
export const closure1983_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h1fe8bbdeafb5d387: (a: number, b: number) => void;
export const closure2417_externref_shim: (a: number, b: number, c: any, d: any) => void;
