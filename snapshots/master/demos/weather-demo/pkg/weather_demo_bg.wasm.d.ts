...
export const closure1865_externref_shim: (a: number, b: number, c: any) => void;
export const closure2298_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf28cd95c45301a00: (a: number, b: number) => void;
