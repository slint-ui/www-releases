...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h2ffd9d510217b58b: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h0a6170431b10f847: (a: number, b: number) => void;
