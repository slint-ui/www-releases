...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h486d70488baed83b: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h0e2606ec72936b5f: (a: number, b: number) => void;
