...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h05be87a6edb803fe: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h1699cd2aa37e7665: (a: number, b: number) => void;
