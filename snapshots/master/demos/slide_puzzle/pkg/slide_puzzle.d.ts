...
export interface InitOutput {
  ...
  readonly main: () => void;
  readonly wasm_bindgen__convert__closures_____invoke__h322e6e1c7aa3c235: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h0a9eb73ddbef6420: (a: number, b: number) => void;
