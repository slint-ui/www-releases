...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7d1d694a2e466a48: (a: number, b: number) => void;
  readonly closure515_externref_shim: (a: number, b: number, c: any, d: any) => void;
