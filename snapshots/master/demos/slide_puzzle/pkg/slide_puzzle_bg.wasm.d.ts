...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he80b020066cfb94b(a: number, b: number): void;
export function closure569_externref_shim(a: number, b: number, c: number, d: number): void;
