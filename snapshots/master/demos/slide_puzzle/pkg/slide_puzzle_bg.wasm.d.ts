...
export const closure285_externref_shim: (a: number, b: number, c: any) => void;
export const closure560_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h110184a9eb99101c: (a: number, b: number) => void;
