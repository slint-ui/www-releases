...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4425b0fde1aaa4bf: (a: number, b: number) => void;
export const closure575_externref_shim: (a: number, b: number, c: any, d: any) => void;
