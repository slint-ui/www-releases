...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h6b9d029163d4abb2: (a: number, b: number) => void;
export const closure502_externref_shim: (a: number, b: number, c: any, d: any) => void;
