...
export const wasm_bindgen__convert__closures_____invoke__he107b988414649d2: (a: number, b: number) => void;
export const closure564_externref_shim: (a: number, b: number, c: any) => void;
export const closure466_externref_shim: (a: number, b: number, c: any, d: any) => void;
