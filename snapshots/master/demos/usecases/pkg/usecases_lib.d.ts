...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h4703ef614d6cbab1: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h0399f6d02c1d60c4: (a: number, b: number) => void;
