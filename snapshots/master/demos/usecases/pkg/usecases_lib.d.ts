...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h494450a4aacafa45: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h50e6dddbc8285bba: (a: number, b: number) => void;
