...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h5220d5b593d42733: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h072fb7d3d79adace: (a: number, b: number) => void;
