...
export const closure3445_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h2df447169abbed51: (a: number, b: number) => void;
export const closure3951_externref_shim: (a: number, b: number, c: any) => void;
export const closure4014_externref_shim: (a: number, b: number, c: any) => void;
export const closure3952_externref_shim: (a: number, b: number, c: any, d: any) => void;
