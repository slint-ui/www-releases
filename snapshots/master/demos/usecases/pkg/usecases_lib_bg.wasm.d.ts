...
export const closure3963_externref_shim: (a: number, b: number, c: any) => void;
export const closure4026_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hc8db5c7b4472991d: (a: number, b: number) => void;
export const closure3964_externref_shim: (a: number, b: number, c: any, d: any) => void;
