...
export const closure3350_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h6a40db2b4f8b4a31: (a: number, b: number) => void;
export const closure3966_externref_shim: (a: number, b: number, c: any) => void;
export const closure3967_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure4019_externref_shim: (a: number, b: number, c: any) => void;
