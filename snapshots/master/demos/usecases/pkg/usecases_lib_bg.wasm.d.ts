...
export const closure3987_externref_shim: (a: number, b: number, c: any) => void;
export const closure3988_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure4050_externref_shim: (a: number, b: number, c: any) => void;
