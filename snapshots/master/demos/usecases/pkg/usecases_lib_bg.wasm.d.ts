...
export const wasm_bindgen__convert__closures_____invoke__hef6bb83541650260: (a: number, b: number) => void;
...
export const closure4044_externref_shim: (a: number, b: number, c: any) => void;
export const closure3982_externref_shim: (a: number, b: number, c: any, d: any) => void;
