...
export const closure3112_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure3113_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3179_externref_shim: (a: number, b: number, c: any) => void;
