...
export const closure3963_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3528_externref_shim: (a: number, b: number, c: any) => void;
export const closure3962_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h2df447169abbed51: (a: number, b: number) => void;
export const closure4025_externref_shim: (a: number, b: number, c: any) => void;
