...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h0f206c2e663ae02e: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0f206c2e663ae02e_5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0d54574b5abc0e2b_6: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0f206c2e663ae02e_7: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0d54574b5abc0e2b_8: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0f206c2e663ae02e_9: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0d54574b5abc0e2b_10: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0f206c2e663ae02e_11: (a: number, b: number, c: any) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h0f206c2e663ae02e_14: (a: number, b: number, c: any) => void;
