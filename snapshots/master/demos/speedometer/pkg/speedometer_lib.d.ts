...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h2ddb2f3e5720cc79: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h397303abe192f8e3: (a: number, b: number) => void;
