...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h097a63dbc40708ef: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h097a63dbc40708ef_5: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h291c027ccf20bd6b_6: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h097a63dbc40708ef_7: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h291c027ccf20bd6b_8: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h097a63dbc40708ef_9: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h291c027ccf20bd6b_10: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h097a63dbc40708ef_11: (a: number, b: number, c: any) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h097a63dbc40708ef_14: (a: number, b: number, c: any) => void;
