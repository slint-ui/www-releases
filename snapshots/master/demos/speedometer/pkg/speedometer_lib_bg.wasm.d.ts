...
export const closure700_externref_shim: (a: number, b: number, c: any) => void;
export const closure1109_externref_shim: (a: number, b: number, c: any) => void;
export const closure1047_externref_shim: (a: number, b: number, c: any, d: any) => void;
