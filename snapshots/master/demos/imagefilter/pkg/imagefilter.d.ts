...
export interface InitOutput {
    ...
    readonly main: () => void;
    readonly wasm_bindgen__closure__destroy__h0e0add30d2211c75: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h0dc3e37587b61825: (a: number, b: number, c: any) => void;
