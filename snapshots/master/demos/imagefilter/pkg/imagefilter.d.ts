...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h484863f0a6f4e229: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h09f38db8a7f40e67: (a: number, b: number) => void;
