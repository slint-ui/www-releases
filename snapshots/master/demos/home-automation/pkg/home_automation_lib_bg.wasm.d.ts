...
export const closure4654_externref_shim: (a: number, b: number, c: any) => void;
export const closure4207_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h3282760391d831ac: (a: number, b: number) => void;
export const closure4608_externref_shim: (a: number, b: number, c: any, d: any) => void;
