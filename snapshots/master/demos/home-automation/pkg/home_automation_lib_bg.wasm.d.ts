...
export const closure4071_externref_shim: (a: number, b: number, c: any) => void;
export const closure4585_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h4f9d799e0850d818: (a: number, b: number) => void;
