...
export const closure4189_externref_shim: (a: number, b: number, c: any) => void;
export const closure4599_externref_shim: (a: number, b: number, c: any) => void;
export const closure4662_externref_shim: (a: number, b: number, c: any) => void;
export const closure4600_externref_shim: (a: number, b: number, c: any, d: any) => void;
