...
export const closure4583_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h06f9942906b52c61: (a: number, b: number) => void;
export const closure4110_externref_shim: (a: number, b: number, c: any) => void;
export const closure4646_externref_shim: (a: number, b: number, c: any) => void;
export const closure4584_externref_shim: (a: number, b: number, c: any, d: any) => void;
