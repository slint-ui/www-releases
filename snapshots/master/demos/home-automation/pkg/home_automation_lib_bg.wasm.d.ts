...
export const closure4648_externref_shim: (a: number, b: number, c: any) => void;
export const closure4324_externref_shim: (a: number, b: number, c: any) => void;
export const closure4585_externref_shim: (a: number, b: number, c: any) => void;
