...
export const closure4595_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h4a4df537b16e3a7e: (a: number, b: number) => void;
export const closure4596_externref_shim: (a: number, b: number, c: any, d: any) => void;
