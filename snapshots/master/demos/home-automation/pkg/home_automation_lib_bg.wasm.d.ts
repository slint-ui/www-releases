...
export const closure4126_externref_shim: (a: number, b: number, c: any) => void;
export const closure4579_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0b774892d95d8b83: (a: number, b: number) => void;
