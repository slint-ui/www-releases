...
export const closure4154_externref_shim: (a: number, b: number, c: any) => void;
export const closure4650_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hf15d27f702d3199f: (a: number, b: number) => void;
