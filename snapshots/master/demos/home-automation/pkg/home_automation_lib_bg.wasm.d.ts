...
export const closure4127_externref_shim: (a: number, b: number, c: any) => void;
export const closure4579_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1f204bdf12a336f9: (a: number, b: number) => void;
