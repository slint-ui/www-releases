...
export const closure4123_externref_shim: (a: number, b: number, c: any) => void;
export const closure4575_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf4f2f0ebceab0fb0: (a: number, b: number) => void;
