...
export const closure4193_externref_shim: (a: number, b: number, c: any) => void;
export const closure4601_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure4664_externref_shim: (a: number, b: number, c: any) => void;
