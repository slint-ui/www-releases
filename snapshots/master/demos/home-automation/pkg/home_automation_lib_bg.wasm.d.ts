...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h46dad25267b9548c: (a: number, b: number) => void;
export const closure4610_externref_shim: (a: number, b: number, c: any, d: any) => void;
