...
export const closure4607_externref_shim: (a: number, b: number, c: any, d: any) => void;
...
export const wasm_bindgen__convert__closures_____invoke__hadf28ff0ad66deb5: (a: number, b: number) => void;
