...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd1c91ff285c417e3: (a: number, b: number) => void;
export const closure4046_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure4084_externref_shim: (a: number, b: number, c: any) => void;
