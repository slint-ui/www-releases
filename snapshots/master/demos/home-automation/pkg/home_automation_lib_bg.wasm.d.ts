...
export const closure3534_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7e17579f4326f921: (a: number, b: number) => void;
export const closure3957_externref_shim: (a: number, b: number, c: any) => void;
export const closure3958_externref_shim: (a: number, b: number, c: any, d: any) => void;
