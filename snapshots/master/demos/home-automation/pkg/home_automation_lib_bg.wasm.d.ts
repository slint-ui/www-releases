...
export const closure4581_externref_shim: (a: number, b: number, c: any) => void;
export const closure4582_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure4322_externref_shim: (a: number, b: number, c: any) => void;
export const closure4644_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h06f9942906b52c61: (a: number, b: number) => void;
