...
export const closure4310_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h06f9942906b52c61: (a: number, b: number) => void;
export const closure4590_externref_shim: (a: number, b: number, c: any) => void;
export const closure4591_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure4653_externref_shim: (a: number, b: number, c: any) => void;
