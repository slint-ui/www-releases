...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h309ac6b949c1eac3: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h63ca646260988a8f: (a: number, b: number) => void;
