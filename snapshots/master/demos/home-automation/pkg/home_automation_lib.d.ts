...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h05b0ed68816c2fc6: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h42bdc3ccb803d1c4: (a: number, b: number) => void;
