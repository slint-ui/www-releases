...
export const closure3762_externref_shim: (a: number, b: number, c: any) => void;
export const closure4033_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h760c31292b94f57a: (a: number, b: number) => void;
