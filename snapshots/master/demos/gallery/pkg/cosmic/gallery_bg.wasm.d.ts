...
export const closure4353_externref_shim: (a: number, b: number, c: any) => void;
export const closure4606_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h34e608f44c4f0ff0: (a: number, b: number) => void;
