...
export const closure4351_externref_shim: (a: number, b: number, c: any) => void;
export const closure4606_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc4e8d5a5e0a2868d: (a: number, b: number) => void;
export const closure4617_externref_shim: (a: number, b: number, c: any, d: any) => void;
