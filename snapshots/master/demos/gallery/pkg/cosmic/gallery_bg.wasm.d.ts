...
export const closure4514_externref_shim: (a: number, b: number, c: any) => void;
export const closure4707_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha2226e8bd7080e9b: (a: number, b: number) => void;
export const closure4712_externref_shim: (a: number, b: number, c: any, d: any) => void;
