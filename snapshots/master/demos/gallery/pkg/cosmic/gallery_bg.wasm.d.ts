...
export const closure3572_externref_shim: (a: number, b: number, c: any) => void;
export const closure3922_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h713c247bbfa85df3: (a: number, b: number) => void;
export const closure3935_externref_shim: (a: number, b: number, c: any, d: any) => void;
