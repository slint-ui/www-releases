...
export const closure3552_externref_shim: (a: number, b: number, c: any) => void;
export const closure3824_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3577d227db6fc309: (a: number, b: number) => void;
export const closure3829_externref_shim: (a: number, b: number, c: any, d: any) => void;
