...
export const closure4485_externref_shim: (a: number, b: number, c: any) => void;
export const closure4670_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h82117a43b70fce42: (a: number, b: number) => void;
export const closure4682_externref_shim: (a: number, b: number, c: any, d: any) => void;
