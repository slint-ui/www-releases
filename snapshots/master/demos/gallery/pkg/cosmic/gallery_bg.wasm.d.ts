...
export const closure4586_externref_shim: (a: number, b: number, c: any) => void;
export const closure4787_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha2748726d8553a1b: (a: number, b: number) => void;
export const closure4800_externref_shim: (a: number, b: number, c: any, d: any) => void;
