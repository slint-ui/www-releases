...
export function closure3546_externref_shim(a: number, b: number, c: number): void;
...
export function closure3821_externref_shim(a: number, b: number, c: number, d: number): void;
