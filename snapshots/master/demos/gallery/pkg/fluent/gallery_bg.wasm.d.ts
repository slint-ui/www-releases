...
export const closure2928_externref_shim: (a: number, b: number, c: any) => void;
export const closure3200_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb872146494cf6f75: (a: number, b: number) => void;
export const closure3207_externref_shim: (a: number, b: number, c: any, d: any) => void;
