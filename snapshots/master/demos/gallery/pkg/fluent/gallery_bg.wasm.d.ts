...
export const closure2927_externref_shim: (a: number, b: number, c: any) => void;
export const closure3177_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h57c821cf16b1cc0a: (a: number, b: number) => void;
export const closure3190_externref_shim: (a: number, b: number, c: any, d: any) => void;
