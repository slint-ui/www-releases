...
export const closure3200_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hbe8c0ea5f396120b: (a: number, b: number) => void;
export const closure3213_externref_shim: (a: number, b: number, c: any, d: any) => void;
