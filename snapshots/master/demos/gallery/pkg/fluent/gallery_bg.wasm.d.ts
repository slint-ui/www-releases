...
export const closure3313_externref_shim: (a: number, b: number, c: any) => void;
export const closure3497_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h55477db37d8bee8f: (a: number, b: number) => void;
export const closure3510_externref_shim: (a: number, b: number, c: any, d: any) => void;
