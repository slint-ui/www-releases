...
export const closure3667_externref_shim: (a: number, b: number, c: any) => void;
export const closure3471_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h9e9f82e33a7aea34: (a: number, b: number) => void;
export const closure3576_externref_shim: (a: number, b: number, c: any, d: any) => void;
