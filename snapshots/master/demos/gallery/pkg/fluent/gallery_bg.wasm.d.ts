...
export const closure2935_externref_shim: (a: number, b: number, c: any) => void;
export const closure3167_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb5c4058a86fa3e17: (a: number, b: number) => void;
export const closure3181_externref_shim: (a: number, b: number, c: any, d: any) => void;
