...
export function closure2938_externref_shim(a: number, b: number, c: number): void;
...
export function closure3213_externref_shim(a: number, b: number, c: number, d: number): void;
