...
export const closure3085_externref_shim: (a: number, b: number, c: any) => void;
export const closure3319_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf074b30ba1054943: (a: number, b: number) => void;
export const closure3328_externref_shim: (a: number, b: number, c: any, d: any) => void;
