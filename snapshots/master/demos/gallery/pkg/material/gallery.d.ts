...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h1c2fcfe431117ee5: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h12d8649a833cfda7: (a: number, b: number) => void;
