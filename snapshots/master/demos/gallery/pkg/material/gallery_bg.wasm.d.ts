...
export const closure2762_externref_shim: (a: number, b: number, c: any) => void;
export const closure3016_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__heee9237cba4c7eb6: (a: number, b: number) => void;
export const closure3028_externref_shim: (a: number, b: number, c: any, d: any) => void;
