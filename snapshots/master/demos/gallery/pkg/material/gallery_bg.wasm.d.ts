...
export function closure2651_externref_shim(a: number, b: number, c: number): void;
...
export function closure2922_externref_shim(a: number, b: number, c: number, d: number): void;
