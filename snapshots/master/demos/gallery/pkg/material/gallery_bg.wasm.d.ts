...
export const closure2784_externref_shim: (a: number, b: number, c: any) => void;
export const closure3016_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h58427505da8f0424: (a: number, b: number) => void;
export const closure3025_externref_shim: (a: number, b: number, c: any, d: any) => void;
