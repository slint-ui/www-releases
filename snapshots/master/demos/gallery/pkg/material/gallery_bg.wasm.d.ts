...
export const closure2789_externref_shim: (a: number, b: number, c: any) => void;
export const closure3042_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc3ae85fde5246643: (a: number, b: number) => void;
export const closure3056_externref_shim: (a: number, b: number, c: any, d: any) => void;
