...
export const closure3462_externref_shim: (a: number, b: number, c: any) => void;
export const closure3267_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h0edb6a1aed6dc497: (a: number, b: number) => void;
export const closure3367_externref_shim: (a: number, b: number, c: any, d: any) => void;
