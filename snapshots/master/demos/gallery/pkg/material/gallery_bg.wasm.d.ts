...
export const closure3139_externref_shim: (a: number, b: number, c: any) => void;
export const closure3323_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf84feae5e2c43940: (a: number, b: number) => void;
