...
export const closure3247_externref_shim: (a: number, b: number, c: any) => void;
export const closure3429_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__he35086c741a4c9a7: (a: number, b: number) => void;
export const closure3443_externref_shim: (a: number, b: number, c: any, d: any) => void;
