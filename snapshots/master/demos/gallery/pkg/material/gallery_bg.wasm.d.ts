...
export const closure2835_externref_shim: (a: number, b: number, c: any) => void;
export const closure3177_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h5bd9f7c3d9bb66ac: (a: number, b: number) => void;
export const closure3191_externref_shim: (a: number, b: number, c: any, d: any) => void;
