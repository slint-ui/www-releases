...
export function closure2652_externref_shim(a: number, b: number, c: number): void;
...
export function closure2913_externref_shim(a: number, b: number, c: number, d: number): void;
