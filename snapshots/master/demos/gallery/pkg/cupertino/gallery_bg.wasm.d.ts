...
export const wasm_bindgen__convert__closures_____invoke__h90287a03ff9fcc2c: (a: number, b: number) => void;
export const closure4355_externref_shim: (a: number, b: number, c: any) => void;
export const closure4159_externref_shim: (a: number, b: number, c: any) => void;
export const closure4263_externref_shim: (a: number, b: number, c: any, d: any) => void;
