...
export const closure4231_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hae6442de7405f272: (a: number, b: number) => void;
export const closure4244_externref_shim: (a: number, b: number, c: any, d: any) => void;
