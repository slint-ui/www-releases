...
export function closure3163_externref_shim(a: number, b: number, c: number): void;
...
export function closure3438_externref_shim(a: number, b: number, c: number, d: number): void;
