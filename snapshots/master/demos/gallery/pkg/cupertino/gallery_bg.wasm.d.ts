...
export const closure4359_externref_shim: (a: number, b: number, c: any) => void;
export const closure4162_externref_shim: (a: number, b: number, c: any) => void;
export const closure4268_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h0edb6a1aed6dc497: (a: number, b: number) => void;
