...
export const closure4316_externref_shim: (a: number, b: number, c: any) => void;
export const closure4222_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h0edb6a1aed6dc497: (a: number, b: number) => void;
export const closure4099_externref_shim: (a: number, b: number, c: any) => void;
