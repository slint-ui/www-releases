...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h18dd96eec557c31d: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h4759c6bc3a0482e4: (a: number, b: number) => void;
