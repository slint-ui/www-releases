...
export const closure3731_externref_shim: (a: number, b: number, c: any) => void;
export const closure3348_externref_shim: (a: number, b: number, c: any) => void;
export const closure3794_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h2df447169abbed51: (a: number, b: number) => void;
export const closure3732_externref_shim: (a: number, b: number, c: any, d: any) => void;
