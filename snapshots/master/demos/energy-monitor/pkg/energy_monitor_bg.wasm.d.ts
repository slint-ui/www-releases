...
export const closure3736_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3798_externref_shim: (a: number, b: number, c: any) => void;
export const closure3735_externref_shim: (a: number, b: number, c: any) => void;
export const closure3352_externref_shim: (a: number, b: number, c: any) => void;
