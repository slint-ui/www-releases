...
export const closure3564_externref_shim: (a: number, b: number, c: any) => void;
export const closure3565_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3603_externref_shim: (a: number, b: number, c: any) => void;
