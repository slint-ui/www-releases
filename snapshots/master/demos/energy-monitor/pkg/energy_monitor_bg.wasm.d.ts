...
export const closure3728_externref_shim: (a: number, b: number, c: any) => void;
export const closure3319_externref_shim: (a: number, b: number, c: any) => void;
export const closure3729_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3791_externref_shim: (a: number, b: number, c: any) => void;
