...
export const closure3777_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h4f2a8510686ff682: (a: number, b: number) => void;
export const closure3714_externref_shim: (a: number, b: number, c: any) => void;
export const closure3127_externref_shim: (a: number, b: number, c: any) => void;
export const closure3715_externref_shim: (a: number, b: number, c: any, d: any) => void;
