...
export const closure3732_externref_shim: (a: number, b: number, c: any) => void;
export const closure3220_externref_shim: (a: number, b: number, c: any) => void;
export const closure3795_externref_shim: (a: number, b: number, c: any) => void;
export const closure3733_externref_shim: (a: number, b: number, c: any, d: any) => void;
