...
export const closure3733_externref_shim: (a: number, b: number, c: any) => void;
export const closure3334_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h2916b1085d69d425: (a: number, b: number) => void;
export const closure3780_externref_shim: (a: number, b: number, c: any) => void;
export const closure3734_externref_shim: (a: number, b: number, c: any, d: any) => void;
