...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h27d07e96db599636: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h167a7ce182dbebc0: (a: number, b: number) => void;
