...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h16d100b03cb96acc: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h160362d6dafd1a1f: (a: number, b: number) => void;
