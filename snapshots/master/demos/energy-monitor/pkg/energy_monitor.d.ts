...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h50494a590506b1bc: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h6b4ddeb5f64e6efb: (a: number, b: number) => void;
