...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h3ccf263d529a72ab: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h0dadd344e35f8ed5: (a: number, b: number) => void;
