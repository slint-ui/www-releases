...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h0cd9e762cde15306: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h035e2be0afdd4100: (a: number, b: number) => void;
