...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h26ce75fc044a87a8: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h0f42dc7ae2a6220c: (a: number, b: number) => void;
