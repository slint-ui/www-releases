...
export const closure2809_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure2810_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2854_externref_shim: (a: number, b: number, c: any) => void;
