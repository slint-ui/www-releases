...
export const closure2827_externref_shim: (a: number, b: number, c: any) => void;
export const closure3258_externref_shim: (a: number, b: number, c: any) => void;
export const closure3321_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hc8db5c7b4472991d: (a: number, b: number) => void;
export const closure3259_externref_shim: (a: number, b: number, c: any, d: any) => void;
