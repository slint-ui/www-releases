...
export const closure3257_externref_shim: (a: number, b: number, c: any) => void;
export const closure2826_externref_shim: (a: number, b: number, c: any) => void;
export const closure3258_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h4f2a8510686ff682: (a: number, b: number) => void;
export const closure3320_externref_shim: (a: number, b: number, c: any) => void;
