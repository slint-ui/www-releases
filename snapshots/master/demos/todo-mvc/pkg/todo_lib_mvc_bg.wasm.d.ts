...
export const closure2311_externref_shim: (a: number, b: number, c: any) => void;
export const closure2761_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure2762_externref_shim: (a: number, b: number, c: any, d: any) => void;
