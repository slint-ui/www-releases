...
export const closure2262_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure2814_externref_shim: (a: number, b: number, c: any) => void;
export const closure2815_externref_shim: (a: number, b: number, c: any, d: any) => void;
