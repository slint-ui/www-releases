...
export const closure3004_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure3005_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3070_externref_shim: (a: number, b: number, c: any) => void;
