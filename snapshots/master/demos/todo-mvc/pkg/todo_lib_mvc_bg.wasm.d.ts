...
export const closure3008_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure3009_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3089_externref_shim: (a: number, b: number, c: any) => void;
