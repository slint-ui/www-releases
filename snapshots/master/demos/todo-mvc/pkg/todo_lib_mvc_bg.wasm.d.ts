...
export const closure2893_externref_shim: (a: number, b: number, c: any) => void;
export const closure3277_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3339_externref_shim: (a: number, b: number, c: any) => void;
export const closure3276_externref_shim: (a: number, b: number, c: any) => void;
