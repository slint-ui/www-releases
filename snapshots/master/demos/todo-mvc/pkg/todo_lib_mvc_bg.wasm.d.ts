...
export const closure3323_externref_shim: (a: number, b: number, c: any) => void;
export const closure2878_externref_shim: (a: number, b: number, c: any) => void;
...
export const wasm_bindgen__convert__closures_____invoke__hec96763067b8c433: (a: number, b: number) => void;
