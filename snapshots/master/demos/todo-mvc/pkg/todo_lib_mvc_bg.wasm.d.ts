...
export const closure2932_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure2933_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure3000_externref_shim: (a: number, b: number, c: any) => void;
