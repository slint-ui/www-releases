...
export const closure3001_externref_shim: (a: number, b: number, c: any) => void;
export const closure3345_externref_shim: (a: number, b: number, c: any) => void;
export const closure3282_externref_shim: (a: number, b: number, c: any) => void;
export const closure3283_externref_shim: (a: number, b: number, c: any, d: any) => void;
