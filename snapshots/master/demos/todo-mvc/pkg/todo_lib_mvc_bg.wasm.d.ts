...
export const closure3015_externref_shim: (a: number, b: number, c: any) => void;
export const closure3273_externref_shim: (a: number, b: number, c: any) => void;
export const closure3274_externref_shim: (a: number, b: number, c: any, d: any) => void;
