...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h35f6a0579a977d78: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h2b533e7e3f14bccd: (a: number, b: number, c: any) => void;
