...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h36fd008b7d029c2f: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h2cfea6e32b9d85b8: (a: number, b: number) => void;
