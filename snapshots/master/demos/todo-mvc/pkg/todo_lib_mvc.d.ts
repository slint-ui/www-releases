...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h24219e6b97ebd1f1: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h1fc30d46fccbfa30: (a: number, b: number) => void;
