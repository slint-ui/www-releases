...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h018dbb04afe320fd: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h1fc210473ca2e874: (a: number, b: number) => void;
