...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h048962e4ceba1ba4: (a: number, b: number, c: any) => void;
  readonly wasm_bindgen__closure__destroy__h656e65c5b80ff1d8: (a: number, b: number) => void;
