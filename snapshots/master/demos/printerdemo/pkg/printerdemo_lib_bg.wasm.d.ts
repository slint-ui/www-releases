...
export const closure2252_externref_shim: (a: number, b: number, c: any) => void;
...
export const closure2601_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2653_externref_shim: (a: number, b: number, c: any) => void;
