...
export const closure2103_externref_shim: (a: number, b: number, c: any) => void;
...
export const wasm_bindgen__convert__closures_____invoke__hb7ed6d41986ab2d7: (a: number, b: number) => void;
