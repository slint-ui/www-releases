...
export const closure2202_externref_shim: (a: number, b: number, c: any) => void;
export const closure2611_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h2df447169abbed51: (a: number, b: number) => void;
export const closure2674_externref_shim: (a: number, b: number, c: any) => void;
export const closure2612_externref_shim: (a: number, b: number, c: any, d: any) => void;
