...
export const closure2615_externref_shim: (a: number, b: number, c: any) => void;
export const closure2355_externref_shim: (a: number, b: number, c: any) => void;
export const closure2616_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const closure2678_externref_shim: (a: number, b: number, c: any) => void;
