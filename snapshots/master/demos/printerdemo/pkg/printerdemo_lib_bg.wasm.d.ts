...
export const closure2041_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h6a40db2b4f8b4a31: (a: number, b: number) => void;
export const closure2601_externref_shim: (a: number, b: number, c: any) => void;
export const closure2602_externref_shim: (a: number, b: number, c: any, d: any) => void;
