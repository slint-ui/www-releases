...
export const wasm_bindgen__convert__closures_____invoke__h73fc08bcf5b30bd6: (a: number, b: number) => void;
export const closure2118_externref_shim: (a: number, b: number, c: any) => void;
