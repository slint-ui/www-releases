...
export const closure2613_externref_shim: (a: number, b: number, c: any) => void;
export const closure2140_externref_shim: (a: number, b: number, c: any) => void;
export const closure2676_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h2df447169abbed51: (a: number, b: number) => void;
export const closure2614_externref_shim: (a: number, b: number, c: any, d: any) => void;
