...
export function closure147_externref_shim(a: number, b: number, c: number): void;
...
export function closure335_externref_shim(a: number, b: number, c: number, d: number): void;
