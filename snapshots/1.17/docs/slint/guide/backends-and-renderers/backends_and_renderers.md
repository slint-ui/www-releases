...
The Qt renderer comes with the [Qt backend](/master/docs/slint/guide/backends-and-renderers/backend_qt.md) and renders using QPainter:
...
- Available in `no_std` environments as well as in the [Winit backend](/master/docs/slint/guide/backends-and-renderers/backend_winit.md) and [LinuxKMS backend](/master/docs/slint/guide/backends-and-renderers/backend_linuxkms.md).
