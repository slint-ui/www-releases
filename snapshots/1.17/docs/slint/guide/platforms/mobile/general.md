...
By default, Slint [ScrollView](/master/docs/slint/reference/std-widgets/views/scrollview.md)s only scroll by dragging the scrollbar or the mouse wheel. This is fine for desktop, but
