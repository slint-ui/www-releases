...
The global [Palette](/master/docs/slint/reference/std-widgets/globals/palette.md) and [StyleMetrics](/master/docs/slint/reference/std-widgets/globals/stylemetrics.md) properties can be accessed and will be set to the appropriate values of the current style.
