...
**T type**
Many of the math functions can be used with any [numeric type](/master/docs/slint/reference/primitive-types.md#numeric-types) such as `angle`, `duration`, `float`, `int`, `length`, and `percent`. These are represented on this page as `T`.
