...
This convenience property gives easy read only access to that value. It represents a point specifying the absolute position within the enclosing [Window](/master/docs/slint/reference/window/window.md) or [PopupWindow](/master/docs/slint/reference/window/popupwindow.md).
