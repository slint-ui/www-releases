...
When designing custom components, consider early on to declare [accessibility properties](/master/docs/slint/reference/common.md#accessibility-properties). At least a role, possibly a label, as well as actions.
...
* When adding user-visible strings to your UI, consider early on to mark them as [translatable](/master/docs/slint/guide/development/translations.md) by wrapping them in `@tr("...")`.
