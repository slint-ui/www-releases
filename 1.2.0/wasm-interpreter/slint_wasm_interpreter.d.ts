...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1__h3407c15589b347ff: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hc7931cd654c34edf: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h15913e6bf2ca0fed: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h9f56d31ee591f4b8: (a: number, b: number, c: number, d: number) => void;
