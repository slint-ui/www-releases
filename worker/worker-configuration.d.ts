/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 64ea54d03dd65da20feedb915c31ab59)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LATEST_RELEASE">> {}
}
