...
export function wasm_bindgen__convert__closures__invoke1__h71219291f0ee30ca(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h20d18f1b7461ab6d(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h112bc8d864bce221(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__hd5d83a06edcc446f(a: number, b: number, c: number, d: number): void;
