...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1__h1e71d1ec50da464b: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0a9ded76874ba1de: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h2acea8e9f86eb98b: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h4650d19514700b47: (a: number, b: number, c: number, d: number) => void;
