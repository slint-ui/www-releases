...
export const wasm_bindgen__convert__closures_____invoke__hf8e33d5bb12e3820: (a: number, b: number) => void;
export const closure4264_externref_shim: (a: number, b: number, c: any, d: any) => void;
