...
export const closure2440_externref_shim: (a: number, b: number, c: any) => void;
export const closure2503_externref_shim: (a: number, b: number, c: any) => void;
export const closure2441_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hbf9021a1efdc38cb: (a: number, b: number) => void;
