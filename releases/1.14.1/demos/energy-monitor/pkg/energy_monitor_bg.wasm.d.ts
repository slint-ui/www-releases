...
export const closure3737_externref_shim: (a: number, b: number, c: any, d: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h746550ebbb74ac03: (a: number, b: number) => void;
