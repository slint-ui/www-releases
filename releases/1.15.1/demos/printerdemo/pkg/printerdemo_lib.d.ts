...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h4a8be1fea3641388: (a: number, b: number) => void;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h38662ace91b651f3: (a: number, b: number, c: any) => void;
