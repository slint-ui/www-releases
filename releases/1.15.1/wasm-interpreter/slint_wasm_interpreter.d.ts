...
export interface InitOutput {
    ...
    readonly wasm_bindgen__closure__destroy__h00270bead584e8fd: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h7bbf17af961f7de4: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0276684539f68451: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2cade1a19c28a887: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0f0042610ccdd08b: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h57d2b89db7f5c9f8: (a: number, b: number) => void;
