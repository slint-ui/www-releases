...
export function wasm_bindgen__convert__closures__invoke1__h3bae415b525e4b41(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h24e3cff492a60d61(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h022382884bd560c5(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h23f2675e411b26ad(a: number, b: number, c: number, d: number): void;
