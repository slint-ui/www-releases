...
export function wasm_bindgen__convert__closures__invoke1_mut__h0b4ef0586ca9a37a(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hdf1dec434b56db2f(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1__h0be08639a8c44412(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h05d09e11b292ef76(a: number, b: number, c: number, d: number): void;
