...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1__h453ef2d1543ada21: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0d4639bd600e3ef6: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h87ca3084378a2867: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h35cdb40c70a88d02: (a: number, b: number, c: number, d: number) => void;
