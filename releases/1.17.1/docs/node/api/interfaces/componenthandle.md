...
> **get** **window**(): [`Window`](/1.17.1/docs/node/api/interfaces/window/)
...
Returns the [Window](/1.17.1/docs/node/api/interfaces/window/) associated with this component instance.
...
icon is hidden, or when [quitEventLoop](/1.17.1/docs/node/api/functions/quiteventloop/) is called.

This function is a convenience for calling [show](/1.17.1/docs/node/api/interfaces/componenthandle/#show), followed by [runEventLoop](/1.17.1/docs/node/api/functions/runeventloop/), and
[hide](/1.17.1/docs/node/api/interfaces/componenthandle/#hide) when the event loop's promise is resolved.
