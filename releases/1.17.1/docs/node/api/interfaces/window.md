...
> **logicalPosition**: [`Point`](/1.17.1/docs/node/api/interfaces/point/)
...
> **logicalSize**: [`Size`](/1.17.1/docs/node/api/interfaces/size/)
...
> **physicalPosition**: [`Point`](/1.17.1/docs/node/api/interfaces/point/)
...
> **physicalSize**: [`Size`](/1.17.1/docs/node/api/interfaces/size/)
