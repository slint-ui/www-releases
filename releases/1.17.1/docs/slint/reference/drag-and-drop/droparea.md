...
Use `DropArea` to accept drops coming from a [DragArea](/1.17.1/docs/slint/reference/drag-and-drop/dragarea.md), or from another application on platforms that support it.
...
The argument is a [DropEvent](/1.17.1/docs/slint/reference/global-structs-enums.md#dropevent) describing the drag.
