...
Use the `Image` element to display an [image](/1.17.1/docs/slint/reference/primitive-types.md#image).
...
Use the [`@image-url` macro](/1.17.1/docs/slint/reference/primitive-types.md#image) to specify the image's path.
</SlintProperty>
