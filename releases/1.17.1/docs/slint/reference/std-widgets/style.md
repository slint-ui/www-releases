...
The global [Palette](/1.17.1/docs/slint/reference/std-widgets/globals/palette.md) and [StyleMetrics](/1.17.1/docs/slint/reference/std-widgets/globals/stylemetrics.md) properties can be accessed and will be set to the appropriate values of the current style.
