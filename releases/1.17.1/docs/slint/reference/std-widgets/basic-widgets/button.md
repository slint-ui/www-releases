...
A simple button. Common types of buttons can also be created with [StandardButton](/1.17.1/docs/slint/reference/std-widgets/basic-widgets/standardbutton.md).
