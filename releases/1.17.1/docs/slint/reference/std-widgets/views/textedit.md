...
Similar to [LineEdit](/1.17.1/docs/slint/reference/std-widgets/views/lineedit.md), but can be used to enter several lines of text
...
-   **`clear-focus()`** Call this function to remove keyboard focus from this `TextEdit` if it currently has the focus. See also [focus handling](/1.17.1/docs/slint/guide/development/focus.md).
