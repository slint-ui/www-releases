...
A property that is used with the [StyledText element](/1.17.1/docs/slint/reference/elements/styledtext.md).
...
In addition, call the [math functions](/1.17.1/docs/slint/reference/global-functions/math.md) in postfix style on any numeric value,
...
A brush is a special type that can be either initialized from a `color` or a `gradient`. See [Colors & Brushes](/1.17.1/docs/slint/reference/colors-and-brushes.md).
...
RGB color with an alpha channel, with 8 bit precision for each channel. CSS color names as well as the hexadecimal color encodings are supported, such as #RRGGBBAA or #RGB. See [Colors & Brushes](/1.17.1/docs/slint/reference/colors-and-brushes.md).
...
See also the [Image element](/1.17.1/docs/slint/reference/elements/image.md).
...
See [DragAndDrop](/1.17.1/docs/slint/guide/development/drag-and-drop.md) for an end-to-end example.
...
which is exposed as [Platform.decimal-separator](/1.17.1/docs/slint/reference/platform.md#decimal-separator) and defaults to the dot (`.`).
...
See the [translations guide](/1.17.1/docs/slint/guide/development/translations.md) for how the decimal separator is determined.