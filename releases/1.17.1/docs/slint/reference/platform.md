...
The name of the currently selected [widget style](/1.17.1/docs/slint/reference/std-widgets/style.md). Some widget
styles have dark and light variant suffixes, such as `fluent-light`. This property contains the
style name without the suffix. Use [Palette](/1.17.1/docs/slint/reference/std-widgets/globals/palette.md)'s `color-scheme` to
...
See the [translations guide](/1.17.1/docs/slint/guide/development/translations.md) for details.
</SlintProperty>
