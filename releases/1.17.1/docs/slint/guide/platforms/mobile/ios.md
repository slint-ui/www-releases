...
respective simulators. This is implemented through the [Winit backend](/1.17.1/docs/slint/guide/backends-and-renderers/backend_winit.md) and the
[Skia Renderer](/1.17.1/docs/slint/guide/backends-and-renderers/backends_and_renderers.md#skia-renderer).
