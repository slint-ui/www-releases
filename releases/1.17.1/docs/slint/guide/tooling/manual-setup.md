...
- [Visual Studio Code](/1.17.1/docs/slint/guide/tooling/vscode.md)
- [Kate](/1.17.1/docs/slint/guide/tooling/kate.md)
- [Qt Creator](/1.17.1/docs/slint/guide/tooling/qt-creator.md)
- [Helix](/1.17.1/docs/slint/guide/tooling/helix.md)
- [(Neo-)Vim](/1.17.1/docs/slint/guide/tooling/neo-vim.md)
- [Sublime Text](/1.17.1/docs/slint/guide/tooling/sublime-text.md)
- [JetBrains IDE](/1.17.1/docs/slint/guide/tooling/jetbrains-ide.md)
- [Zed](/1.17.1/docs/slint/guide/tooling/zed.md)
...
See the [Slint Viewer](/1.17.1/docs/slint/guide/tooling/slint-viewer.md) page for installation, screenshots, and all command-line options.
