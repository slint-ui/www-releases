...
Use the [debug()](/1.17.1/docs/slint/reference/global-functions/builtinfunctions.md#debug) function to print the values of properties to stderr.
...
[cache-rendering-hint](/1.17.1/docs/slint/reference/common.md#cache-rendering-hint) to `true` on the `BarChar` itself, which surrounds and captures the individual bar charts.
