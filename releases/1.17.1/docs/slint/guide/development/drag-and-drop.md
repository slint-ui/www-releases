...
Use [DragArea](/1.17.1/docs/slint/reference/drag-and-drop/dragarea.md) and [DropArea](/1.17.1/docs/slint/reference/drag-and-drop/droparea.md) to move data between parts of the UI with a drag-and-drop gesture.
On platforms that support it, a [DropArea](/1.17.1/docs/slint/reference/drag-and-drop/droparea.md) also accepts drops from other applications.
