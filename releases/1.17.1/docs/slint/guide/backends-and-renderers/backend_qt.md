...
If Qt is not installed, the backend will be disabled, and Slint will fallback to another backend, usually the [Winit backend](/1.17.1/docs/slint/guide/backends-and-renderers/backend_winit.md).
