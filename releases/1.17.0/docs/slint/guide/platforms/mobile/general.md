...
By default, Slint [ScrollView](/1.17.0/docs/slint/reference/std-widgets/views/scrollview.md)s only scroll by dragging the scrollbar or the mouse wheel. This is fine for desktop, but
...
In Slint, this area is exposed with the [Window.safe-area-insets](/1.17.0/docs/slint/reference/window/window.md#safe-area-insets) property on the [Window](/1.17.0/docs/slint/reference/window/window.md) element.
...
The way Slint exposes this is by these two properties defining a rectangle on the [Window](/1.17.0/docs/slint/reference/window/window.md) element:

* [Window.virtual-keyboard-position](/1.17.0/docs/slint/reference/window/window.md#virtual-keyboard-position)
* [Window.virtual-keyboard-size](/1.17.0/docs/slint/reference/window/window.md#virtual-keyboard-size)
...
scrollable area ([Flickable](/1.17.0/docs/slint/reference/gestures/flickable.md)) in its parent element chain (up to the window). If it finds one, that area is
...
As you can see, the [ScrollView](/1.17.0/docs/slint/reference/std-widgets/views/scrollview.md) doesn't need to be the direct parent of the [LineEdit](/1.17.0/docs/slint/reference/std-widgets/views/lineedit.md).
