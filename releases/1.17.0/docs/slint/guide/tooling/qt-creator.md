...
Refer to the instruction from the [Kate page](/1.17.0/docs/slint/guide/tooling/kate.md#syntax-highlighting) to enable syntax highlighting.

### LSP

To install the Slint Language server, check the [LSP Documentation](/1.17.0/docs/slint/guide/tooling/manual-setup.md#slint-lsp).
