...
See [Converting Between Numbers and Strings](/1.17.0/docs/slint/reference/primitive-types.md#converting-between-numbers-and-strings) for the conversion rules.

Read the currently used separator from [Platform.decimal-separator](/1.17.0/docs/slint/reference/platform.md#decimal-separator).
