...
Export a global to make it accessible from other files (see [Modules](/1.17.0/docs/slint/guide/language/coding/file.md#modules)). To make your global
...
:::note[Note]
Global singletons aren't shared between separate windows, or between a window and a [SystemTrayIcon](/1.17.0/docs/slint/reference/window/systemtrayicon.md) exported alongside it.
