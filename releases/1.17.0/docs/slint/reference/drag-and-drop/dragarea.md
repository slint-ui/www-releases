...
and the value bound to `data` becomes the drag payload delivered to a [DropArea](/1.17.0/docs/slint/reference/drag-and-drop/droparea.md).
A click doesn't start a drag, so child elements like [TouchArea](/1.17.0/docs/slint/reference/gestures/toucharea.md) stay interactive.
...
See [DragAndDrop](/1.17.0/docs/slint/guide/development/drag-and-drop.md) for a usage guide and a complete example.
...
The payload that's transferred to a [DropArea](/1.17.0/docs/slint/reference/drag-and-drop/droparea.md) when a drop happens.
</SlintProperty>
