...
widgets, such as the [ScrollView](/1.17.0/docs/slint/reference/std-widgets/views/scrollview.md) or [ListView](/1.17.0/docs/slint/reference/std-widgets/views/listview.md).
...
You can use a [ScrollView](/1.17.0/docs/slint/reference/std-widgets/views/scrollview.md) instead or add your own scroll bars.
