...
A ListView is like a [ScrollView](/1.17.0/docs/slint/reference/std-widgets/views/scrollview.md) but it should have a `for` element, and the contents are
...
[ScrollView](/1.17.0/docs/slint/reference/std-widgets/views/scrollview.md) is more suitable for free-form content.
...
Same as [ScrollView](/1.17.0/docs/slint/reference/std-widgets/views/scrollview.md).
