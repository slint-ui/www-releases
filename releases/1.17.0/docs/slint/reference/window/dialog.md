...
Dialog can be used in place of [Window](/1.17.0/docs/slint/reference/window/window.md), but it has buttons that are automatically laid out.
...
Same as [Window](/1.17.0/docs/slint/reference/window/window.md).
