...
> **data**: [`DataTransfer`](/1.17.0/docs/node/api/classes/datatransfer/)
...
> **proposed\_action**: [`DragAction`](/1.17.0/docs/node/api/slint-ui/namespaces/language/type-aliases/dragaction/)
