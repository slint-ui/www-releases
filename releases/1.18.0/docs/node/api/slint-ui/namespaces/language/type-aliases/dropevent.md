...
> **data**: [`DataTransfer`](/1.18.0/docs/node/api/classes/datatransfer/)
...
> **proposed\_action**: [`DragAction`](/1.18.0/docs/node/api/slint-ui/namespaces/language/type-aliases/dragaction/)

Defined in: api/node/typescript/generated/language.ts:635
