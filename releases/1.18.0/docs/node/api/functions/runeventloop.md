...
Defined in: [api/node/typescript/index.ts:826](https://github.com/slint-ui/slint/blob/master/api/node/typescript/index.ts#L826)
...
if set to `true` the loop quits once the last window is closed
                         ...
                         [quitEventLoop](/1.18.0/docs/node/api/functions/quiteventloop/) is called. A visible SystemTrayIcon keeps the loop alive
