...
A widget used to enter a single line of text. See [TextEdit](/1.18.0/docs/slint/reference/std-widgets/views/textedit.md) for
...
### clear-focus()
Call this function to remove keyboard focus from this `LineEdit` if it currently has the focus. See also [FocusHandling](/1.18.0/docs/slint/guide/development/focus.md).
