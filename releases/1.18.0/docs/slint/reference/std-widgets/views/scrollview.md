...
scrolled. Compared to a plain [Flickable](/1.18.0/docs/slint/reference/gestures/flickable.md) it has scrollbar to interact with.
...
If you want to display a long list of items, use a [ListView](/1.18.0/docs/slint/reference/std-widgets/views/listview.md) instead, which only instantiates visible children.
:::
