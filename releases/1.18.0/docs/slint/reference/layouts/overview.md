...
See [GridLayout](/1.18.0/docs/slint/reference/layouts/gridlayout.md).
</SlintProperty>
...
Valid on the children of a [HorizontalLayout](/1.18.0/docs/slint/reference/layouts/horizontallayout.md), [VerticalLayout](/1.18.0/docs/slint/reference/layouts/verticallayout.md), or [FlexboxLayout](/1.18.0/docs/slint/reference/layouts/flexboxlayout.md).
</SlintProperty>
