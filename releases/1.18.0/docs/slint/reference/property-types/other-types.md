...
To specify an easing curve, use the values from the `Easing` namespace. For example you can use `Easing.ease-out` or `Easing.ease-in-quad`. The namespace consists of the following names (see [`easings.net`](https://easings.net/) for a visual reference):
    ...
    -   `spring(bounce)` as defined in [Spring Animations](/1.18.0/docs/slint/reference/language/animations.md#spring-animations)
...
See [DragAndDrop](/1.18.0/docs/slint/guide/development/drag-and-drop.md) for an end-to-end example.
...
The `MouseCursor` type is used in the [TouchArea element](/1.18.0/docs/slint/reference/gestures/toucharea.md).
