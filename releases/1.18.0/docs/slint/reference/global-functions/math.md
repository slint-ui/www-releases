...
**T type**
Many of the math functions can be used with any [numeric type](/1.18.0/docs/slint/reference/property-types/numeric-types.md#numeric-types) such as `angle`, `duration`, `float`, `int`, `length`, and `percent`. These are represented on this page as `T`.
