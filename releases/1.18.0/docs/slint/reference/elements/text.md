...
The weight of the font. The values range from 100 (lightest) to 900 (thickest). 400 is the normal weight. Use the [FontWeight](/1.18.0/docs/slint/reference/global-namespaces/font-weight.md) namespace for predefined constants.
...
:::note[Note]
  ...
  See [FontHandling](/1.18.0/docs/slint/guide/development/fonts.md) for more.
:::
</SlintProperty>
