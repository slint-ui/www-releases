...
Place the `Menu` element in a [MenuBar](/1.18.0/docs/slint/reference/window/window.md#menubar), a `ContextMenuArea`, or within another `Menu`.
...
This property can only be set in a `MenuItem` that is part of a [MenuBar](/1.18.0/docs/slint/reference/window/window.md#menubar).
</SlintProperty>
