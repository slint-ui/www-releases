...
which is exposed as [Platform.decimal-separator](/1.18.0/docs/slint/reference/platform.md#decimal-separator) and defaults to the dot (`.`).
...
See the [translations guide](/1.18.0/docs/slint/guide/development/translations.md) for how the decimal separator is determined.