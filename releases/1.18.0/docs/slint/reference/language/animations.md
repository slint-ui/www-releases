...
For a continuously running value independent of property changes, see [`animation-tick()`](/1.18.0/docs/slint/reference/global-functions/builtinfunctions.md#animation-tick---duration).
</SlintProperty>

### easing

<SlintProperty propName="easing" typeName="easing">
The [easing curve](/1.18.0/docs/slint/reference/property-types/other-types.md#easing) applied over the animation's duration.
...
See [Iterations and Directions](/1.18.0/docs/slint/reference/language/animations.md#iterations-and-directions) below for why.
