...
The Qt renderer comes with the [Qt backend](/1.18.0/docs/slint/guide/backends-and-renderers/backend_qt.md) and renders using QPainter:
...
- Available in `no_std` environments as well as in the [Winit backend](/1.18.0/docs/slint/guide/backends-and-renderers/backend_winit.md) and [LinuxKMS backend](/1.18.0/docs/slint/guide/backends-and-renderers/backend_linuxkms.md).
...
### FemtoVG Renderer
 ...
 - Available in the [Winit backend](/1.18.0/docs/slint/guide/backends-and-renderers/backend_winit.md) and [LinuxKMS backend](/1.18.0/docs/slint/guide/backends-and-renderers/backend_linuxkms.md).
