...
After setting up the syntax highlighting, you can now install the Slint Language server. Check the [LSP Documentation](/1.18.0/docs/slint/guide/tooling/manual-setup.md#slint-lsp) for instructions.
