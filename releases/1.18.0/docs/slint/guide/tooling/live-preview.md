...
It's the same live preview as the one in [VS Code](/1.18.0/docs/slint/guide/tooling/vscode.md),
the [Slint LSP](/1.18.0/docs/slint/guide/tooling/manual-setup.md#slint-lsp), and the [Slint Viewer](/1.18.0/docs/slint/guide/tooling/slint-viewer.md).
