...
Qt Creator supports the same format as Kate. Refer to the instructions for [Kate](/1.18.0/docs/slint/guide/tooling/kate.md#syntax-highlighting) to set up syntax highlighting.

### LSP

To install the Slint Language server, check the [LSP Documentation](/1.18.0/docs/slint/guide/tooling/manual-setup.md#slint-lsp).
