...
Use [DragArea](/1.18.0/docs/slint/reference/drag-and-drop/dragarea.md) and [DropArea](/1.18.0/docs/slint/reference/drag-and-drop/droparea.md) to move data between parts of the UI with a drag-and-drop gesture.
On platforms that support it, a [DropArea](/1.18.0/docs/slint/reference/drag-and-drop/droparea.md) also accepts drops from other applications.

The payload is a [data-transfer](/1.18.0/docs/slint/reference/property-types/other-types.md#data-transfer) value, which abstracts over the file-type transfer mechanisms supported by each platform.
