...
See [Converting Between Numbers and Strings](/1.18.0/docs/slint/reference/language/type-conversions.md#converting-between-numbers-and-strings) for the conversion rules.

Read the currently used separator from [Platform.decimal-separator](/1.18.0/docs/slint/reference/platform.md#decimal-separator).
