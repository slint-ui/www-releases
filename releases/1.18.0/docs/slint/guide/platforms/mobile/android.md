...
A Slint C++ Android application is a standard CMake project (see the [getting started tutorial](/1.18.0/docs/slint/tutorial/getting_started.md)) with an Android-specific Gradle wrapper.
