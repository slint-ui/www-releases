...
export const closure1514_externref_shim: (a: number, b: number, c: any) => void;
export const closure1864_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h8d77d366304a298b: (a: number, b: number) => void;
export const closure1865_externref_shim: (a: number, b: number, c: any, d: any) => void;
