...
export const wasm_bindgen__convert__closures_____invoke__hce768290211beb22: (a: number, b: number) => void;
export const closure4693_externref_shim: (a: number, b: number, c: any, d: any) => void;
